...
const AdmissionForm = () => {
  return (
    <div className="px-4 lg:px-14 py-16 max-w-screen-2xl mx-auto" id="admission-form">
      <h2 className="text-4xl text-neutralDGrey font-semibold mb-8 text-center">
        Admission Form
      </h2>
      <form className="max-w-lg mx-auto">
        ...
        <div className="mb-4">
          ...
          <input type="text" id="name" name="name" className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required />
        </div>
        <div className="mb-4">
          <label htmlFor="email" className="block text-sm font-medium text-gray-700">Email</label>
          <input type="email" id="email" name="email" className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required />
        </div>
        <div className="mb-4">
          <label htmlFor="message" className="block text-sm font-medium text-gray-700">Message</label>
          <textarea id="message" name="message" rows="4" className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"></textarea>
        </div>
        <button type="submit" className="bg-brandPrimary text-white py-2 px-4 rounded hover:bg-neutralDGrey">Submit</button>
      </form>
    </div>
  );
};
